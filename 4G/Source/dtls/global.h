...
typedef unsigned char dtls_uint8;
typedef unsigned char dtls_uint16[2];
typedef unsigned char dtls_uint24[3];
typedef unsigned char dtls_uint32[4];
typedef unsigned char dtls_uint48[6];
...
// in KingSDK, the name is sockaddr;
typedef struct sockaddr session_t;
