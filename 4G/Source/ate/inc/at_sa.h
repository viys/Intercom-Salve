...
typedef enum
{
    AT_ENGINE_MODE_NORMAL,
    AT_ENGINE_MODE_CALIB
} AT_ENGINE_MODE_T;

#define AT_MODE_ENABLE_NORMAL (1 << AT_ENGINE_MODE_NORMAL)
#define AT_MODE_ENABLE_CALIB (1 << AT_ENGINE_MODE_CALIB)
#define AT_MODE_ENABLE_ALL (AT_MODE_ENABLE_NORMAL | AT_MODE_ENABLE_CALIB)
...
typedef struct SA_COMMAND_TABLE_T
{
    ...
    UINT16 mode_enable_flags; // chief switcher. 0: disable, 1: enable.
