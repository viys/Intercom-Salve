...
const at_setting_t gDefaultSettings = {
    ...
    .smsSetting = {
        ...
        .smsInfo = {
            {.nStorage1 = SMS_STORAGE_SM, // Add by XP 20130130 for SMS default storage setting.
             .nStorage2 = SMS_STORAGE_SM,
             .nStorage3 = SMS_STORAGE_SM,
             .sCnmi.nBfr = 0,
             .sCnmi.nBm = 0,
             .sCnmi.nDs = 0,
             .sCnmi.nMode = 2,
        ...
        .smsFormat = 1, // SMS Foramt: 0: PDU 1:text
    },
...
#if defined(AT_MODULE_SUPPORT_OTA)
        .g_OTA_dataconnProfile     = {
            {{
                .profile_id       = 0,                                 /* Profile unique id */
                .apn              = "cmnet",                   /* Access point name */
                .username         = {0},         /* Username */
                .password         = {0},           /* Password */
                .proxy_ip         = "0.0.0.0",               /*IP address */
                .szOperatorName   = {0},
                .port             = 0,           /* Port number. */
                .bear_type        = AT_BEARER_TYPE_DEFUALT_VAL,                      /* Bearer type */
                .conn_mode        = AT_CONNECTION_MODE_DEFUALT_VAL,                      /* Connection mode */
                .gprs_auth_type   = AT_GPRS_AUTH_TYPE_DEFUALT_VAL,           /* GPRS auth type */
                .profile_type     = AT_PROFILE_TYPE_DEFUALT_VAL,   /* Profile type. */
                .nSimID           = 0,
            },
            {
                .profile_id       = 0,                                 /* Profile unique id */
                .apn              = {0},                   /* Access point name */
                .username         = {0},         /* Username */
                .password         = {0},           /* Password */
                .proxy_ip         = {0},               /*IP address */
                .szOperatorName   = {0},
                .port             = 0,           /* Port number. */
                .bear_type        = AT_BEARER_TYPE_DEFUALT_VAL,                      /* Bearer type */
                .conn_mode        = AT_CONNECTION_MODE_DEFUALT_VAL,                      /* Connection mode */
...
#endif
    //.g_staAtGprsCidInfo     = { {{1,},}, },
};

const at_as_setting_t gDefAsSettings = {
    .urcport = AT_URC_PORT_UART1
};
