...
#define REG_ADI_IF_BASE (0x41a40000)
...
#define hwp_adiIf ((HWP_ADI_MST_T *)REG_ACCESS_ADDRESS(REG_ADI_IF_BASE))
...
typedef union {
    ...
    struct
    {
        ...
        uint32_t rf_gssi_wbp_len : 4;       // [27:24]
...
#define ADI_MST_RF_GSSI_WBP_LEN(n) (((n)&0xf) << 24)
