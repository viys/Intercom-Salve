...
#define REG_TIMER1_BASE (0x41806000)
#define REG_TIMER2_BASE (0x41a17000)

typedef volatile struct
{
    uint32_t ostimer_ctrl;       // 0x00000000
    uint32_t ostimer_curval;     // 0x00000004
    uint32_t __8[2];             // 0x00000008
    uint32_t hwtimer_ctrl;       // 0x00000010
    uint32_t hwtimer_curval_l;   // 0x00000014
    uint32_t hwtimer_curval_h;   // 0x00000018
    uint32_t timer_irq_mask_set; // 0x0000001c
    uint32_t timer_irq_mask_clr; // 0x00000020
    uint32_t timer_irq_clr;      // 0x00000024
    uint32_t timer_irq_cause;    // 0x00000028
} HWP_TIMER_T;
...
// hwtimer_curval_l
#define TIMER_CURVAL_L(n) (((n)&0xffffffff) << 0)

// hwtimer_curval_h
#define TIMER_CURVAL_H(n) (((n)&0xffffffff) << 0)
