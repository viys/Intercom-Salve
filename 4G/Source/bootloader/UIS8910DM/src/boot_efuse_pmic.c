...
typedef enum
{
    ...
    EFUSE_PHY_BLK_ID_3,                    /* Fuel gage 的单点校准�?*/
    EFUSE_PHY_BLK_ID_4,
    EFUSE_PHY_BLK_ID_5, /* LDOs参考电压校�?*/
    EFUSE_PHY_BLK_ID_6,
    EFUSE_PHY_BLK_ID_7,
    EFUSE_PHY_BLK_ID_8,
    EFUSE_PHY_BLK_ID_9,
    ...
    EFUSE_PHY_BLK_ID_13, /* CHG CC-CV的校准�?bit CHG_CC-CV<5:0>  */
    EFUSE_PHY_BLK_ID_14, /* Effuse THM校准 */
    EFUSE_PHY_BLK_ID_15, /* DCDC PFM threshold, ZX offset threshold */
    EFUSE_PHY_BLK_ID_16, /* RTC_LDO校准�?*/
    EFUSE_PHY_BLK_ID_17, /* AUXADC offset calibration*/
    EFUSE_PHY_BLK_ID_18, /* AuxADC 的校�?大量程校准电压点�?.2V�?.6V */
    EFUSE_PHY_BLK_ID_19, /* AuxADC 的校�?小量�?电压�?.1V�?.0V */
 ...
 ******************************************************************************/
static EFUSE_RETURN_E _bootEfusePmicReadEx(
    uint32_t block_id,
 ...
 *    3.Each block has 31-bit data.                                           *
 ******************************************************************************/
uint32_t bootEfusePmicRead(uint32_t block_id, uint32_t *des_data_ptr)
{
    ...
    if (true == is_busy_sts)
    {
        bootLog("bootEfusePmicRead READ BUSY");
    ...
    if (false == read_done)
    {
        bootLog("bootEfusePmicRead READ_DONE Error");
        return EFUSE_READ_FAIL;
    }
 ...
 *    3.Each block has 31-bit data.                                           *
 ******************************************************************************/
uint32_t bootEfusePmicWrite(uint32_t block_id, uint32_t write_data)
{
    uint32_t sts = 0;
    uint32_t read_data;
    uint32_t old_tick = 0;
    ...
    if (true == sts)
    {
        bootLog("bootEfusePmicWrite WRITE BUSY");
        return EFUSE_WRITE_FAIL;
    }
    else
    {
        /* read data and compare */
        result = bootEfusePmicRead(block_id, &read_data);
 ...
 *      consecutive.                                                          *
 ******************************************************************************/
uint32_t bootEfuseReadImei(uint8_t *des_data_ptr, uint32_t bit_num)
{
    ...
    {
        result = _bootEfusePmicReadEx(i, temp_ptr);
 ...
 *      consecutive.                                                          *
 ******************************************************************************/
uint32_t bootEfuseWriteImei(uint8_t *src_dat_ptr, uint32_t bit_num)
{
    uint32_t i, min_id, len;
    uint32_t *efuse_ptr;
    uint32_t max_bit;
    ...
    else
    {
        for (i = min_id; i < (min_id + len); i++)
        {
            result = bootEfusePmicWrite(i, (*efuse_ptr) | BIT_31);
