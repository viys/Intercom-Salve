...
static int ssl_parse_server_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    defined(MBEDTLS_SSL_PROTO_TLS1_1)
        ...
        {
            mbedtls_md5_context mbedtls_md5v;
            mbedtls_sha1_context mbedtls_sha1v;

            mbedtls_md5_init(  &mbedtls_md5v  );
            mbedtls_sha1_init( &mbedtls_sha1v );
             ...
             *                            + ServerParams);
             */
            mbedtls_md5_starts( &mbedtls_md5v );
            mbedtls_md5_update( &mbedtls_md5v, ssl->handshake->randbytes, 64 );
            mbedtls_md5_update( &mbedtls_md5v, params, params_len );
            mbedtls_md5_finish( &mbedtls_md5v, hash );

            mbedtls_sha1_starts( &mbedtls_sha1v );
            mbedtls_sha1_update( &mbedtls_sha1v, ssl->handshake->randbytes, 64 );
            mbedtls_sha1_update( &mbedtls_sha1v, params, params_len );
            mbedtls_sha1_finish( &mbedtls_sha1v, hash + 16 );

            mbedtls_md5_free(  &mbedtls_md5v  );
            mbedtls_sha1_free( &mbedtls_sha1v );
        }
        else
