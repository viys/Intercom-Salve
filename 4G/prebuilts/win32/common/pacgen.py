...
def kingapp_gen_args(sub_parsers):
    parser = sub_parsers.add_parser(
        'kingapp-gen', help='generate kingapp pac files')
    parser.set_defaults(func=kingapp_gen)
    parser.add_argument('--cfg', dest='cfg', default=None,
                        help='configuration file name')
    parser.add_argument('fname', help='pac file name')
